    ...
    <div className="App">
      <div className='content'>
        ...
        <div className='top_content' style={{ backgroundImage: `url(${bg})` }}>
          ...
          <div className='couple_name text-reveal' style={{  marginTop: "80px"}}>
          ...
          <div className='couple_text text-reveal text-reveal-delay-3' style={{ height: "20px", lineHeight: "20px" }}>
            <span className='couple_text_style' style={{ textAlign: "start" }}>..................................</span>
          </div>
